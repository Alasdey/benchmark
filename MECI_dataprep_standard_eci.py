...
def _parse_ann_file(path: str) -> Dict:
    ...
    # Rename relation types to canonical labels
    _REL_RENAME = {"CauseEffect": "causes", "EffectCause": "causedby", "NoRel": "norel"}
    relations = {_REL_RENAME.get(k, k): v for k, v in relations.items()}
